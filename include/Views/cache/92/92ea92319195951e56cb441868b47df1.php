...
/* __string_template__936c70e49cf2fc7c709a47c832c77557 */
class __TwigTemplate_fdafd5a217e2ee7bbce7ef6650540779 extends Template
{
    private $source;
    private $macros = [];
...
\t__.Contact.config = {
\t\troles: {\"create\":true,\"update\":true,\"delete\":true,\"modifyTemplate\":true}
\t}
</script>
<script id='filemanager-opts' type='text/javascript'>
    ...
    __.FileManager.roles = {\"upload\":true,\"modify\":true};
</script>
...
<script id='setting-opts' type='text/javascript'>
    __.Setting.roles = {\"modifyConfig\":true,\"modifyRule\":true};
</script>
...
";
    ...
    {
        return "__string_template__936c70e49cf2fc7c709a47c832c77557";
    }
