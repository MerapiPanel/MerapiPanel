...
template.fire = function (key, data) {
  ...
  return new Promise(function (res, rej) {
    ...
    var promises = template.events[key].map( /*#__PURE__*/function () {
...
template.render = function () {
  ...
  __.http.post(template.fetchURL, {
    type: template.filter || null
  ...
  function createComponent(item) {
    return $("<li class=\"list-group-item position-relative d-flex justify-content-start align-items-center \">").append($("<div>").append('<i class="fa-regular fa-file-lines fa-2x text-muted me-2"></i>'), $("<div class=\"ms-1\">").append("<h4 class=\"mb-1\">".concat(item.name, "</h4>")).append($("<div class=\"d-flex justify-content-start align-items-center\">").append(icons[item.contact.type || 'default']).append("<small>".concat(item.contact.name || '<i>No name</i>', "</small>")))).append($("<div class=\"dropdown position-absolute top-0 end-0\">").append($("<button class=\"btn btn-sm dropdown-toggle\" type=\"button\" data-bs-toggle=\"dropdown\" aria-expanded=\"false\">"), $("<ul class=\"dropdown-menu dropdown-menu-end\">").append($("<li class=\"dropdown-item\" type=\"button\">").append("Edit").on('click', function () {
