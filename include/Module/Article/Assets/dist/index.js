...
Article.endpoints = {};
var endpoints = Article.endpoints;
var articles = window.articles || [];
var updateEndpoint = endpoints.update;
var deleteEndpoint = endpoints["delete"];
var viewEndpoint = endpoints.view;
var editURL = endpoints.editURL;
...
function QuickEdit(article, container) {
  ...
  modal.action.positive = function () {
    ...
    var found_article = articles.find(function (a) {
      return a.id === article.id;
    });
    found_article = _objectSpread(_objectSpread({}, article), form.serializeArray().reduce(function (obj, item) {
    ...
    Object.keys(articles[articles.indexOf(article)]).forEach(function (key) {
    ...
    __.http.post(updateEndpoint, found_article).then(function (res) {
      if (res.code === 200) {
