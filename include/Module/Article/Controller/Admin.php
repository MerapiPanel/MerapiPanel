...
class Admin extends __Controller
{
    ...
    function index($view)
    {
        $articles = Box::module("Article")->fetchAll(["id", "title", "slug", "status", "keywords", "category", "description", "post_date", "update_date", "users.id as author_id", "users.name as author_name"]);
