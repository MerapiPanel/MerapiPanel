...
var __ = window.__;
var endpoints = editor.endpoints;
editor.callback = function (data) {
  var _this = this;
  (0,_il4mb_merapipanel_http__WEBPACK_IMPORTED_MODULE_1__.post)(__.product ? endpoints.update : endpoints.add, _objectSpread({
    data: JSON.stringify(data)
  }, {
    id: __.product ? __.product.id : ""
  })).then(function (res) {
    if (res.code === 200) {
      if (__.product) {
        ...
        __.product = res.data;
        window.history.replaceState("", "", window.location.href.replace("new", "edit") + "/" + res.data.id);
      }
    } else {
      if (__.product) {
