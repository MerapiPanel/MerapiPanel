...
/***/ "./include/Module/Product/Assets/src/partial/component.ts":
/*!****************************************************************!*\
  !*** ./include/Module/Product/Assets/src/partial/component.ts ***!
  \****************************************************************/
...
var Register = function Register(editor) {
  ...
  editor.Components.addType("product-input", {
    view: {
      init: function init() {
        var _this$model$component;
        this.$el.val(((_this$model$component = this.model.components()) === null || _this$model$component === void 0 || (_this$model$component = _this$model$component.at(0)) === null || _this$model$component === void 0 ? void 0 : _this$model$component.get("content")) || "");
      },
      events: {
        input: 'handleInputUpdate'
      },
      handleInputUpdate: function handleInputUpdate(ev) {
  ...
  editor.Components.addType("product-title", {
    ...
    view: {
      ...
      handleInputUpdate: function handleInputUpdate(ev) {
        ...
        this.model.components(ev.target.value);
        var height = Math.max(ev.target.scrollHeight, 50) + 'px';
  ...
  editor.Components.addType("product-description", {
    ...
    view: {
      ...
      handleInputUpdate: function handleInputUpdate(ev) {
        ...
        this.model.components(ev.target.value);
        var height = Math.max(ev.target.scrollHeight, 35) + 'px';
        $(ev.target).css('height', height);
      }
    }
  });
...
"use strict";
/*!*****************************************************!*\
  !*** ./include/Module/Product/Assets/src/editor.ts ***!
  \*****************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _partial_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./partial/component */ "./include/Module/Product/Assets/src/partial/component.ts");
...
var endpoints = MProduct.endpoints;
editor.callback = function (data) {
  var _this = this;
  (0,_il4mb_merapipanel_http__WEBPACK_IMPORTED_MODULE_1__.post)(MProduct.data.id ? endpoints.update : endpoints.add, _objectSpread({
    data: JSON.stringify(data)
  }, {
    id: MProduct.data ? MProduct.data.id : ""
  })).then(function (res) {
    if (res.code === 200) {
      if (MProduct.data.id) {
        _this.resolve("Product updated successfully");
      } else {
        _this.resolve("Product saved successfully");
      ...
      if (MProduct.data) {
        _this.reject(res.message || "Failed to update product");
      } else {
        _this.reject(res.message || "Failed to save product");
      }
    }
  })["catch"](function (err) {
    if (MProduct.data) {
      _this.reject(err.message || "Failed to update product");
    } else {
      _this.reject(err.message || "Failed to save product");
    }
  });
};
editor.onReady = function (editor) {
  _partial_component__WEBPACK_IMPORTED_MODULE_0__.Register(editor);
  if (MProduct.data.id && MProduct.data.data) {
    var _MProduct$data$data, _MProduct$data$data2;
    editor.setComponents((_MProduct$data$data = MProduct.data.data) === null || _MProduct$data$data === void 0 ? void 0 : _MProduct$data$data.components);
    editor.addStyle((_MProduct$data$data2 = MProduct.data.data) === null || _MProduct$data$data2 === void 0 ? void 0 : _MProduct$data$data2.css);
  } else {
  ...
  editor.BlockManager.getCategories().forEach(function (category, index) {
